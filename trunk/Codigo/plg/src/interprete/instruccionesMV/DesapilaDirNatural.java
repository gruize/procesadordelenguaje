...
public class DesapilaDirNatural extends InstruccionMaquinaP{
	private Integer dir;
	public DesapilaDirNatural(){
		dir = null;
	}
	public DesapilaDirNatural(int dir){
		this.dir = dir;
	}
	...
	public byte[] toBytes() {
		...
		int pos = 0;
		bytes[pos++] = InstruccionMaquinaP.DESAPILA_DIR_NATURAL;
		if (dir == null)
			return bytes;
		MyNatural n = new MyNatural();
		n.setValue(dir);
	...
	public static DesapilaDirNatural fromBytes(byte[] bytes, int pos){
		if (bytes[pos++]!= InstruccionMaquinaP.DESAPILA_DIR_NATURAL){
			return null;
		}
		DesapilaDirNatural i = new DesapilaDirNatural();
		i.dir = (Integer)new MyNatural().fromBytes(bytes, pos).getValue();
		return i; 
	}
	public String toString(){
		return "Code="+InstruccionMaquinaP.DESAPILA_DIR_NATURAL+". desapilaDir";
	}
