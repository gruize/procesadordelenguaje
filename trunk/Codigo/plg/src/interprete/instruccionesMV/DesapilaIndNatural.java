...
public class DesapilaIndNatural extends InstruccionMaquinaP{
	...
	public static DesapilaIndNatural fromBytes(byte[] bytes, int pos){
		if (bytes[pos++]!= InstruccionMaquinaP.DESAPILA_IND_NATURAL){
			return null;
		}
		return new DesapilaIndNatural();
	}
	public String toString(){
		return "Code="+InstruccionMaquinaP.DESAPILA_IND_NATURAL+". desapila_ind";
	}
