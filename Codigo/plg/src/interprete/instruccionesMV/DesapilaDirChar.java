...
public class DesapilaDirChar extends InstruccionMaquinaP{
	private Integer dir;
	public DesapilaDirChar(){
		dir = null;
	}
	public DesapilaDirChar(int dir){
		this.dir = dir;
	}
	...
	public byte[] toBytes() {
		...
		int pos = 0;
		bytes[pos++] = InstruccionMaquinaP.DESAPILA_DIR_CHAR;
		if (dir == null)
			return bytes;
		MyNatural n = new MyNatural();
		n.setValue(dir);
	...
	public static DesapilaDirChar fromBytes(byte[] bytes, int pos){
		if (bytes[pos++]!= InstruccionMaquinaP.DESAPILA_DIR_CHAR){
			return null;
		}
		DesapilaDirChar i = new DesapilaDirChar();
		i.dir = (Integer)new MyNatural().fromBytes(bytes, pos).getValue();
		return i; 
	}
	public String toString(){
		return "Code="+InstruccionMaquinaP.DESAPILA_DIR_CHAR+". desapilaDir";
	}
