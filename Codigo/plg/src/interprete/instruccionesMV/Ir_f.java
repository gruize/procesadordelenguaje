...
public class Ir_f extends InstruccionMaquinaP{
	...
	public byte[] toBytes() {
		...
		int pos = 0;
		bytes[pos++] = InstruccionMaquinaP.IR_F;
		if (dir == null)
			return bytes;
		MyNatural n = new MyNatural();
		n.setValue(dir);		
	...
	public static Ir_f fromBytes(byte[] bytes, int pos){
		if (bytes[pos++]!= InstruccionMaquinaP.IR_F){
			return null;
		}
		Ir_f i = new Ir_f();
	...
	public String toString(){
		return "Code="+InstruccionMaquinaP.IR_F+". Ir_f";
	}
